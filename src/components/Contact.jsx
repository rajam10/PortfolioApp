        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-1 gap-6">
          <div className="card-surface">
            <div className="mt-2 contact-links">
              ...
              <a className="contact-link" href="https://github.com/" target="_blank" rel="noreferrer noopener">
              ...
              <a className="contact-link" href="https://www.linkedin.com/" target="_blank" rel="noreferrer noopener">
